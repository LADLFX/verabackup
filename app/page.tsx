...
function LoadingSpinner() {
  return (
    <div className="flex h-[300px] w-full items-center justify-center">
      <div className="h-8 w-8 animate-spin rounded-full border-4 border-[#0F4342] border-t-transparent" />
    </div>
  )
}
  ...
  return (
    <Carousel className="w-full">
      ...
      <div className="flex justify-center mt-4">
        <CarouselPrevious className="relative mr-2" aria-label="Previous slide" />
        <CarouselNext className="relative ml-2" aria-label="Next slide" />
      </div>
    </Carousel>
  )
}
